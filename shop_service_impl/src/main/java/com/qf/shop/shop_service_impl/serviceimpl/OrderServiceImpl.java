...
public class OrderServiceImpl implements IOrderService{
    ...
    public String addOrderAndOrderDetils(Integer[] cids, Integer aid, Integer uid) {
        ...
        orders.setOrderid(UUID.randomUUID().toString());//避免生成的订单出现重复
        orders.setPerson(address.getPerson());//订单的收货人
        orders.setAddress(address.getAddress());//收货人地址
        orders.setPhone(address.getPhone());//收货人电话
        ...
        return orders.getOrderid();//返回订单编号，是支付的重要凭证
    }
